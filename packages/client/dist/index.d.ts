...
type SubjectGuard$1<TSubject extends object | null | undefined, TSubjectGuarded extends object | null | undefined> = (subject: TSubject) => {
	subject: TSubjectGuarded;
} | null | undefined;
...
type Rule$1<TResource, TSubject extends object | null | undefined, TGuardedSubject extends object | null | undefined = TSubject> = ((subject: TSubject, resource: TResource) => Promise<Permission$1<TGuardedSubject>>) & {
	/**
	 * Subject guard
	 */
	guard: SubjectGuard$1<TSubject, TGuardedSubject>;
};
type InferRule$1<T> = T extends Rule$1<infer TResource, infer TSubject, infer TGuardedSubject> ? {
	resource: TResource;
	subject: TSubject;
	guardedSubject: TGuardedSubject;
} : never;
type InferRuleResource$1<T> = InferRule$1<T>["resource"];
type InferRuleGuardedSubject$1<T> = InferRule$1<T>["guardedSubject"];
declare const RULE_KEY_SEPARATOR$1: ":";
type Ruleset$1<TSubject extends object | null | undefined> = DeepObject$1<Rule$1<any, TSubject, any>>;
type RulesetKeys$1<TRuleset extends Ruleset$1<any>> = RecursiveKeysTo$1<TRuleset, TRuleset extends Ruleset$1<infer TSubject> ? Rule$1<any, TSubject, any> : never, typeof RULE_KEY_SEPARATOR$1>;
...
type KilpiConstructor$1<TSubject extends object | null | undefined> = {
	/**
	 * Create subject guard
	 */
 ...
 */
export declare function createKilpiClientSideClient<TKilpiServerClient extends KilpiServerClient<KilpiCore<any, any, any>>>(options: CreateKilpiClientSideClientOptions): {
